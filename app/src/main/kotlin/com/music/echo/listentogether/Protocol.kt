...
@Serializable data class Message(val type: String, val payload: JsonElement? = null)
...
@Serializable data class CreateRoomPayload(val username: String)

@Serializable
data class JoinRoomPayload(@SerialName("room_code") val roomCode: String, val username: String)

@Serializable data class ApproveJoinPayload(@SerialName("user_id") val userId: String)

@Serializable
data class RejectJoinPayload(@SerialName("user_id") val userId: String, val reason: String? = null)
...
@Serializable
data class KickUserPayload(@SerialName("user_id") val userId: String, val reason: String? = null)

@Serializable data class TransferHostPayload(@SerialName("new_host_id") val newHostId: String)
...
@Serializable data class RepliedMessage(val username: String, val message: String)

@Serializable data class SuggestTrackPayload(@SerialName("track_info") val trackInfo: TrackInfo)
...
@Serializable
data class ApproveSuggestionPayload(@SerialName("suggestion_id") val suggestionId: String)
...
@Serializable
data class JoinRequestPayload(@SerialName("user_id") val userId: String, val username: String)
...
@Serializable
data class UserJoinedPayload(@SerialName("user_id") val userId: String, val username: String)

@Serializable
data class UserLeftPayload(@SerialName("user_id") val userId: String, val username: String)
...
@Serializable data class BufferCompletePayload(@SerialName("track_id") val trackId: String)
...
@Serializable data class KickedPayload(val reason: String)
...
@Serializable
data class UserReconnectedPayload(@SerialName("user_id") val userId: String, val username: String)

@Serializable
data class UserDisconnectedPayload(@SerialName("user_id") val userId: String, val username: String)
