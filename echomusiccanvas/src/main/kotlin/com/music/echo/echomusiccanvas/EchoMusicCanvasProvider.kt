package iad1tya.echo.music.nullmusiccanvas
...
@Serializable
data class nullmusicCanvasManifest(
    val items: List<nullmusicCanvasItem> = emptyList()
)

@Serializable
data class nullmusicCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)
