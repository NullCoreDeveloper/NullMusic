...
/**
 * Full playlist track item returned by /playlists/{id}/tracks. [uid] is the playlist-scoped item
 * identifier required by GQL mutations (removeFromPlaylist, moveItemsInPlaylist). It is only
 * populated when tracks are fetched via the GQL fetchPlaylist endpoint.
 */
@Serializable
