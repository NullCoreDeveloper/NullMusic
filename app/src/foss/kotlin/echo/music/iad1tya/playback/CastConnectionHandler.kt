...
/**
 * Stub CastConnectionHandler for F-Droid builds. Cast functionality is not available without Google
 * Play Services.
 */
class CastConnectionHandler(context: Context, scope: CoroutineScope, musicService: MusicService) {
  ...
  fun clearQueue() {}
  /**
   * No-op stub for F-Droid builds (Cast requires Google Play Services). Kept in sync with the GMS
