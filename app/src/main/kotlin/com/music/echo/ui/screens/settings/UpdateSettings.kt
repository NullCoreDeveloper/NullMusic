...
import iad1tya.echo.music.nullmusic.component.UpdateInfoDialog
import iad1tya.echo.music.ui.utils.backToMain
import iad1tya.echo.music.nullmusic.updater.getAutoUpdateCheckSetting
import iad1tya.echo.music.nullmusic.updater.saveAutoUpdateCheckSetting
import iad1tya.echo.music.nullmusic.updater.getUpdateAvailableState
...
import iad1tya.echo.music.nullmusic.updater.saveUpdateNotificationsSetting
import android.widget.Toast
import androidx.compose.ui.res.pluralStringResource
import iad1tya.echo.music.nullmusic.updater.getDownloadedApkCount
import iad1tya.echo.music.nullmusic.updater.clearDownloadedApks
import iad1tya.echo.music.nullmusic.updater.getBetaUpdatesSetting
import iad1tya.echo.music.nullmusic.updater.saveBetaUpdatesSetting
import iad1tya.echo.music.nullmusic.updater.autoClearOldApks
...
fun UpdateSettings(
    ...
    LaunchedEffect(Unit) {
        ...
        try {
            kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
                val text = java.net.URL("https://raw.githubusercontent.com/NullCoreDeveloper/NullMusic/main/upcomingupdate.json?t=${System.currentTimeMillis()}").readText()
    ...
    isHighlighted = (highlightKey == stringResource(R.string.system_update)),
                    ...
                    onClick = {
                        ...
                        if (isFoss) {
                            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/NullCoreDeveloper/NullMusic"))
