...
/**
 * Personalized Spotify home feed returned by the `home` GQL operation. Mirrors what
 * open.spotify.com shows on its landing page: Daily Mix, Discover Weekly, Release Radar, Jump back
 * in, recently played, etc.
 */
