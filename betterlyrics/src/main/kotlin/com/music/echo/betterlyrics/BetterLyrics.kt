...
object BetterLyrics {
  ...
  suspend fun getLyrics(
    ...
    val ttml =
      fetchTTML(artist, title, duration, album) ?: throw IllegalStateException("Lyrics unavailable")
  ...
  suspend fun getAllLyrics(
    ...
    getLyrics(title, artist, duration, album).onSuccess { lrcString -> callback(lrcString) }
  }
}
