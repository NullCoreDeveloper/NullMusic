...
internal class InverseLayerScope : GraphicsLayerScope {
  ...
  fun DrawTransform.inverseTransform(density: Density, layerBlock: GraphicsLayerScope.() -> Unit) {
    ...
    inverseTransformAtTopLeft(rotationZ = rotationZ, scaleX = scaleX, scaleY = scaleY)
  }
