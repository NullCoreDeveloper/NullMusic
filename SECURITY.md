...
If you discover a security vulnerability in NullMusic, please report it responsibly:

1. **Do NOT** create a public GitHub issue
2. Email us at: [security@nullmusic.fun](mailto:security@nullmusic.fun)
...
NullMusic is committed to user privacy:
...
- Email: [security@nullmusic.fun](mailto:security@nullmusic.fun)
- GitHub: Create a private security advisory

Thank you for helping keep NullMusic secure!
